 ...
 */
public class MALLETselectionFlickr {
	 ...
	 */
	public MALLETselectionFlickr(ArrayList aPositiveTrainList,
	...
	public static void test1() {
		...
		try {
			...
			MALLETselectionFlickr mi = new MALLETselectionFlickr(positiveList, negativeList);
	...
	public static Hashtable<listtype, Collection<String>> selectFeatures(
		...
		Hashtable<listtype, ArrayList<Terms>> lists = MALLETselectionFlickr.getTagLists(
				number, con, sql);
	...
	public static void main(String[] args) {
        ...
        instances = new InstanceList (new SerialPipes(pipeList));
	        ...
	        System.out.println("Only MALLET");
			for (emotion i : emotion.values()) 
			{
				...
				for (String temp : map.get(i.num))
				{
			       ...
			       //String str="t"+indlist[0]+" t"+indlist[1]+" t"+indlist[2]+" t"+indlist[3]+" t"+indlist[4];
				...
				int[] indlist = getHighestIndexes(scores, 20);
		...
		System.out.println();
		  ...
		  System.out.println("converting to pos and neg");
			for (emotion i : emotion.values()) {
	    		...
	    		System.out.println(map.get(i.num).get(0));
	    		System.out.println(map.get(i.num).get(1));
	    		System.out.println(map.get(i.num).get(2));
