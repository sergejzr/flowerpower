...
import analyze.TermPos;
import analyze.Terms;
...
public class Test2 {
	 ...
	 */
	public Test2(ArrayList aPositiveTrainList,
	...
	public static void test1() {
		...
		try {
			...
			Test2 mi = new Test2(positiveList, negativeList);
	...
	public static Hashtable<listtype, Collection<String>> selectFeatures(
		...
		Hashtable<listtype, ArrayList<Terms>> lists = Test2.getTagLists(
				number, con, sql);
	...
	public static void main(String[] args) {
        ...
        instances = new InstanceList (new SerialPipes(pipeList));
		  ...
		  System.out.println("converting to topic representation");
		 
			MICategoryCal2 mic= new MICategoryCal2(emomap,model);
			mic.computePositiveAndNegativeMIvalues(emotion.JOY.num);
			ArrayList<newMI.MICategoryCal2.TermMI> temp = mic.getCategoryRepresentativesMap().get(""+emotion.JOY.num);
			System.out.println();
			for(newMI.MICategoryCal2.TermMI t: temp)
				System.out.print(labels.get(t.term)+", ");
			mic.computePositiveAndNegativeMIvalues(emotion.FEAR.num);
			ArrayList<newMI.MICategoryCal2.TermMI> temp2 = mic.getCategoryRepresentativesMap().get(""+emotion.FEAR.num);
			System.out.println();
			for(newMI.MICategoryCal2.TermMI t: temp2)
				System.out.print(labels.get(t.term)+", ");
