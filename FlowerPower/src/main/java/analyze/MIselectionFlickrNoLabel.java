 ...
 */
public class MIselectionFlickrNoLabel {
	 ...
	 */
	public MIselectionFlickrNoLabel(ArrayList aPositiveTrainList,
	...
	public static void test1() {
		...
		try {
			...
			MIselectionFlickrNoLabel mi = new MIselectionFlickrNoLabel(positiveList, negativeList);
	...
	public static Hashtable<listtype, Collection<String>> selectFeatures(
		...
		Hashtable<listtype, ArrayList<Terms>> lists = MIselectionFlickrNoLabel.getTagLists(
				number, con, sql);
