...
g2d.setStroke(curstroke);
	...
	Point corner=getCorner(bi, ww/2+shiftmargin,hh/2+shiftmargin);
		...
		if(firstresize){
		setBounds(0, 0, (int)(globalrect.getX()+ globalrect.getWidth()+200), (int)(globalrect.getY()+ globalrect.getHeight()+200));
		setPreferredSize(new Dimension((int)(globalrect.getX()+ globalrect.getWidth()+200), (int)(globalrect.getY()+ globalrect.getHeight()+200)));
		}
	//	BufferedImage bi=new BufferedImage((int)(maxbounds.getWidth()-maxbounds.getX()), (int)(maxbounds.getHeight()-maxbounds.getY()), BufferedImage.TYPE_INT_ARGB);
		
	//	gnew.fillRect((int)maxbounds.getX(), (int)maxbounds.getY(), (int)(maxbounds.getWidth()-maxbounds.getX()), (int)(maxbounds.getHeight()-maxbounds.getY()));
