...
public class FlowerTimeline {
	...
	public FlowerTimeline(String flowertitle, File dir, String flowerxml) {
...
String getHTML(){return sb.toString();}
	...
	public static String createTable(String title, File dir,String xmlfile) {

		

			FlowerTimeline ftl=new FlowerTimeline(title,dir, xmlfile);
			return ftl.getHTML();
	...
	public static void main(String[] args) {
		...
		String html = createTable("title",dir,cf.getName());
		FileWriter fw;
		try {
